...
/**
 * The animated figures of M1. Their CSS lives in `global.css` for the reason `m4.spec.ts`
...
const ANIMATED_FIGURES: Record<string, string[]> = {
  '/curso/m1/01-datos-y-tokenizacion/': ['fig--bpe', 'fig--packing'],
};
...
test.describe('the animated figures of M1', () => {
