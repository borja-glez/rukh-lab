...
sigue es exactamente la frontera entre el proyecto de ML y la web.
...
Cuatro ajustes de ORT y cuatro párrafos de comentario, que es la proporción correcta cuando cada
línea es una decisión de despliegue.
...
`block` vive aquí, y el comentario dice exactamente por qué: ORT Web no expone el `rukh_block` que el
