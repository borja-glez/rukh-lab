...
```sh
uv run rukh export --ckpt checkpoints/tiny-AAAAMMDD-HHMMSS/best.pt --out artifacts/onnx/tiny --fp16 --int8 --check-parity --positions 200
...
**Cómo se mide**: `uv run rukh export --ckpt checkpoints/small/best.pt --out artifacts/onnx/small
