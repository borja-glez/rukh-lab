...
description:
  ...
  entradas aleatorias, y las 561 de GRPO: el grupo como línea base, el estimador k3, la caché de
...
## GRPO: 561 líneas donde el grupo es la línea base
...
**El grupo es la línea base, así que un grupo sin dispersión no vale nada.** Si las ocho muestras
...
línea base en la media de una distribución que nadie sigue.
...
<Callout kind="hoy" title="Los mensajes de log están en español">
  ...
  cuatro líneas se quedaron en castellano y sin tildes. No cambia nada de lo que el código hace; se
  apunta porque el curso muestra el fichero tal cual está en `p5` y porque una salida de log
  mezclada es de las cosas que se arreglan cuando alguien tiene que hacer `grep` sobre ella.
</Callout>
...
Los dos primeros son la línea base. El grupo que se pone de acuerdo da ventajas exactamente cero
