...
description:
  'Los cinco labs con sus salidas reales: el encoder bidireccional y el enmascarado, las tres
  cabezas con el tronco congelado, las tres etapas y la curva por etiquetas, la medición contra la heurística,
  y la exportación con los embeddings. Después, el encoder de 39 millones que se publicó y la barra de
  evaluación en vivo.'
module: m3
order: 3
duration: 150
...
<Callout kind="hoy" title="Punto de partida, si te saltaste algo">
  ...
  página. El de 15 millones de los labs 1-3 se entrena siempre en local: son quince minutos y la
...
| Variante                    | Pearson    | Spearman   | F1 de error | margen    |
| --------------------------- | ---------- | ---------- | ----------- | --------- |
| publicado en M3 (15 M, MSE) | 0,6476     | 0,5205     | 0,1804      | +9,17     |
| 15 M + orden                | 0,6621     | 0,6395     | 0,1774      | +8,87     |
| **39 M + orden**            | **0,7261** | **0,6665** | **0,1855**  | **+9,68** |

</div>

El reparto dice dónde estaba el valor: la pérdida dio **+0,119** de Spearman y triplicar la
capacidad **+0,027**. Subir a 87 millones daría un par de centésimas y no acercaría el listón. Y
el listón sigue sin cumplirse —0,6665 frente a 0,80—, con una razón que ahora está medida por
bandas de |cp| sobre diez mil posiciones:
...
Donde la ventaja está decidida, el encoder ya pasa de 0,80. Falla en las posiciones casi
igualadas, que son el 61 % del conjunto, y ordenarlas exige ver táctica: este modelo no tiene
búsqueda. El criterio global está dominado por el caso en el que el enfoque tiene un techo
estructural, y el número que se publica es el real, con el desglose al lado.
