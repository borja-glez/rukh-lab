...
uv run rukh eval encoder --model checkpoints/encoder-v4/best.pt --stage encoder-v4
uv run rukh export --ckpt checkpoints/encoder-v4/best.pt --out artifacts/onnx/encoder --kind encoder --fp16 --int8 --check-parity
```
