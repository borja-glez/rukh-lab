...
- **Exactitud del resultado** sobre las tres clases, con la advertencia de que su techo es bajo por
  ...
  evaluación del `last-n` sobre las 10 000 posiciones retenidas.
...
<RepoTag
  ...
  at="final"
  module="M3"
  note="El encoder de 39 millones con el que cierra la parte de labs se hizo después y está en la etiqueta p3-elo-1200."
/>
