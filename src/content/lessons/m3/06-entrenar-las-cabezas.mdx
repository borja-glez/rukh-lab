...
<Callout kind="ejecuta" title="El preentrenamiento ya se puede probar">
  ...
  que los tests del enmascarado de la lección anterior, y el comando `rukh train encoder` que los usa,
...
imprime es uno solo. Un `--mode` inválido sale con código 2, el que typer usa para un mal uso del
comando, y un error de datos con 1: la distinción importa en un script que encadena comandos.

<Callout kind="ejecuta" title="Una tirada corta de las cabezas, con datos de verdad">
  El comando ya responde. Antes de los afinados de cuatro mil pasos de los labs, una tirada de humo
