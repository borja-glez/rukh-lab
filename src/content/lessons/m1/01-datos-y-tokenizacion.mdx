...
nada nuevo: bastará con poner `<w1500>` al principio y muestrear. Con un matiz que se midió
después y conviene llevar desde aquí: el eje sirve para **imitar** un nivel, no para ganar
partidas. Pedirle al modelo que juegue como un 2600 le cambia las jugadas de forma medible y **no
le sube el Elo**, porque condicionar mueve la distribución de salida y no crea competencia que no
estuviera dentro. Es la distinción entre dirigir un modelo y mejorarlo, y vale para cualquier
prompt de sistema que hayas escrito. Ese selector de la demo se decide
