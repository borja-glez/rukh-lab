...
ejecución de referencia (RTX 5090, 19 de septiembre de 2026), pegadas tal cual. La única que falta
es la consola del esquema `san` del lab 3, que no se capturó; sus estadísticas sí están medidas.
...
La consola del esquema `san` es la única salida de esta lección que no se capturó en la ejecución
de referencia; sus estadísticas sí, y están en la tabla de aquí abajo.
...
- **SAN por carácter**: media **422,44**, p50 393, p95 754 y solo el **7,77 %** cabe en 200. Cinco
  veces más largo que UCI, exactamente la proporción que anunciaba la teoría, y con la ventana de
  200 tokens del curso sería inservible: más de nueve de cada diez partidas se cortarían.
