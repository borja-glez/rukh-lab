...
debería exigir conocer el framework de nadie. Pero el resto del ecosistema habla `PreTrainedModel`,
y escribir una envoltura es barato mientras que reimplementar LoRA, DPO y GRPO no lo es. Es un
adaptador de enchufe: no cambia el aparato, cambia la clavija.
