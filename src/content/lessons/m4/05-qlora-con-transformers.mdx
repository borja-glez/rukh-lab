...
Cada línea que imprime el subcomando sale de un campo de `QwenReport`, así que la consola y `run.json` no
...
<Callout kind="ejecuta" title="El ensayo de Qwen, de punta a punta">
  Con los dos subcomandos escritos, ensaya el camino entero antes de la media hora de GPU. Hace falta la
