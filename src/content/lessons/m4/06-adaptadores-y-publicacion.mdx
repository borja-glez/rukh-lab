...
`--dry-run` lo dice en la salida en vez de callarse: una orden que sube ficheros y una que no deben
...
<Callout kind="ejecuta" title="Publicar en seco">
  ...
  ficheros. Después, un ensayo de la orden sobre el Qwen de ensayo de la lección 5:
